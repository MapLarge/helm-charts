...
![Version: 3.4.1](https://img.shields.io/badge/Version-3.4.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: maplarge](https://img.shields.io/badge/AppVersion-maplarge-informational?style=flat-square)
...
2. Provide the content of the license file to `.Values.license.license` and the helm chart will generate the secret
...
A commonly-encountered deployment scenario is set up and explained in the [USAGE document](USAGE.md),
located with this README.  This document emphasizes the basic setting requirements, their effect on the deployment,
and the resulting Kubernetes YAML output.
