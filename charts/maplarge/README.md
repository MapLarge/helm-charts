...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| contentSecurityPolicy | object | `{"defaultSrc":"","enabled":true,"fontSrc":"","frameAncestors":"","frameSrc":"","imgSrc":"","mediaSrc":"","scriptSrc":"","styleSrc":""}` | Content Security Policy settings and overrides, if needed for an ingress object. Will be processed with baseHostName to generate correct policy |
