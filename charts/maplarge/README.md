...
![Version: 3.3.2](https://img.shields.io/badge/Version-3.3.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: maplarge](https://img.shields.io/badge/AppVersion-maplarge-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| serviceMonitor | object | `{"additionalLabels":{},"enabled":false,"endpoints":[{"path":"/restapi/v1/apps/ml-prometheus/metrics","port":"http"}],"interval":"30s","metricRelabelings":[],"namespace":"","relabelings":[],"scrapeTimeout":"10s"}` | Configuration for Prometheus ServiceMonitor |
| serviceMonitor.additionalLabels | object | `{}` | Additional labels to add to the ServiceMonitor |
| serviceMonitor.enabled | bool | `false` | Enable ServiceMonitor resource for Prometheus |
| serviceMonitor.endpoints | list | `[{"path":"/restapi/v1/apps/ml-prometheus/metrics","port":"http"}]` | Endpoints to be scraped by Prometheus |
...
| serviceMonitor.namespace | string | `""` | Namespace to deploy the ServiceMonitor. If not set, it will be deployed in the same namespace as the chart |
